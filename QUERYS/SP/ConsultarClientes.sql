...
BEGIN
	...
	RTRIM(DIRECCION) AS DIRECCION,CLIENTES.ID_BARRIO,BARRIOS.NOMBRE AS BARRIO,FECHA_REGISTRO,ID_TIPO,
	RTRIM(ESTADO) AS ESTADO,CONVERT(VARCHAR(10),FECHA_REGISTRO, 120) AS FECHA_REGISTRO,FECHA_MODIFICACION,
