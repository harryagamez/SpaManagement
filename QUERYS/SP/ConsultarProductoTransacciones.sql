ALTER PROCEDURE ConsultarProductoTransacciones(@IdProducto INT, @IdEmpresa VARCHAR(36))
AS
BEGIN
	
	SELECT 
		ID_TRANSACCION,FECHA,TRANSACCIONES.ID_PRODUCTO,CANTIDAD,TRANSACCIONES.ID_TIPOTRANSACCION,
		ID_EMP_CLI AS ID_EMPLEADOCLIENTE, TRANSACCIONES.FECHA_REGISTRO, TRANSACCIONES.FECHA_MODIFICACION, 
