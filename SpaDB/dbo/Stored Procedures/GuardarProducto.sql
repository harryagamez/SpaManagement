CREATE PROCEDURE GuardarProducto(@JsonProducto NVARCHAR(MAX))
AS
BEGIN
	...
	BEGIN TRY
		...
		WHEN MATCHED THEN
			UPDATE SET TARGET.NOMBRE = SOURCE.Nombre, TARGET.DESCRIPCION = SOURCE.Descripcion, TARGET.PRECIO = SOURCE.Precio,
		...
		WHEN NOT MATCHED THEN
			...
			VALUES (SOURCE.Nombre, SOURCE.Descripcion, SOURCE.Precio, SOURCE.Inventario, GETDATE(), GETDATE(),
			SOURCE.Id_Empresa);	
