...
BEGIN
	...
	Estado CHAR(10) COLLATE SQL_Latin1_General_CP1_CI_AS)

	INSERT INTO #TempEmpresa (Id_Empresa, Nombre, Direccion, Telefono_Fijo, Telefono_Movil, Mail, Logo, Descripcion, Id_SedePrincipal, Id_Categoria_Servicio, Estado)
	SELECT 
		Id_Empresa, Nombre, Direccion, Telefono_Fijo, Telefono_Movil, Mail, Logo,
		Descripcion, Id_SedePrincipal, Id_Categoria_Servicio, Estado
	FROM 
	...
	BEGIN TRY
		...
		WHEN NOT MATCHED THEN
			INSERT (ID_EMPRESA, NOMBRE, DESCRIPCION, DIRECCION, TELEFONO_FIJO, TELEFONO_MOVIL, MAIL, LOGO, ID_SEDEPRINCIPAL, ID_CATEGORIA_SERVICIO, ESTADO)
			VALUES (NEWID(), SOURCE.Nombre, SOURCE.Descripcion, SOURCE.Direccion, SOURCE.Telefono_Fijo, SOURCE.Telefono_Movil, SOURCE.Mail, SOURCE.Logo, SOURCE.Id_SedePrincipal, SOURCE.Id_Categoria_Servicio, SOURCE.Estado);
