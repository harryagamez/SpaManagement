...
BEGIN
	...
	INSERT INTO #TempServicio (Id_Servicio, Nombre, Descripcion, Tiempo, Valor, Id_TipoServicio, Estado, Id_Empresa)
	SELECT 
	...
	BEGIN TRY
		...
		WHEN MATCHED THEN
			...
			TARGET.FECHA_REGISTRO = GETDATE(), TARGET.FECHA_MODIFICACION = GETDATE()
		WHEN NOT MATCHED THEN
			INSERT (NOMBRE, DESCRIPCION, TIEMPO, VALOR, ID_TIPOSERVICIO, ESTADO, FECHA_REGISTRO, FECHA_MODIFICACION, ID_EMPRESA)
