	...
	BEGIN TRY
		...
		USING(
			SELECT 
				...
				JsonServicio.Tiempo, JsonServicio.Valor, JsonServicio.Estado, 
				JsonServicio.Id_Empresa, JsonServicio.Logo_Base64,
		...
		) AS SOURCE(Id_Empresa_Servicio, Id_Servicio, Tiempo, Valor, Estado, 
		Id_Empresa, Logo_Base64, Usuario_Registro)
		...
		WHEN NOT MATCHED THEN
			INSERT (ID_EMPRESA_SERVICIO, ID_SERVICIO, TIEMPO, VALOR, ESTADO, FECHA_REGISTRO, USUARIO_REGISTRO, 
			ID_EMPRESA, LOGO_BASE64)
			VALUES (@ServicioId, SOURCE.Id_Servicio, SOURCE.Tiempo, SOURCE.Valor, SOURCE.Estado, @FechaActual, 
			SOURCE.Usuario_Registro, SOURCE.Id_Empresa, SOURCE.Logo_Base64);		
