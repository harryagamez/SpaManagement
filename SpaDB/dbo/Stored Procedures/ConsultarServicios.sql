...
BEGIN
	...
	SELECT ID_SERVICIO_IMAGEN, SERVICIO_IMAGENES.ID_SERVICIO, IMAGEN_BASE64, SERVICIO_IMAGENES.FECHA_REGISTRO, SERVICIO_IMAGENES.FECHA_MODIFICACION FROM SERVICIO_IMAGENES INNER JOIN SERVICIOS ON SERVICIO_IMAGENES.ID_SERVICIO = SERVICIOS.ID_SERVICIO

	SELECT * FROM #TempServicios
