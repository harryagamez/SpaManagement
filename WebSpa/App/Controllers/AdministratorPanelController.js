...
function AdministratorPanelController($scope, $state, $location, $filter, $http, $mdDialog, $rootScope, $timeout, AuthService, SPAService) {    
    ...
    $scope.EmpresasGridOptionsColumns = [
        ...
        {
            headerName: "Estado", field: 'estado', width: 160, cellStyle: { 'text-align': 'center', 'cursor': 'pointer' }
        },
        {
            headerName: "Telefono Móvil", field: 'telefono_Movil', width: 160, cellStyle: { 'text-align': 'left', 'cursor': 'pointer' }
        },
    ];
